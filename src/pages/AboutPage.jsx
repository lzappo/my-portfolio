      ...
      <div className="about-page">
        <div className="about-content">
          ...
          >
            ...
            <span className="orange"> Front-End & Mobile App Developer</span> with a love for
            crafting modern, user-friendly experiences using
          ...
          >
            I’m constantly <span className="orange">leveling up</span> my skills — whether it’s
            diving <span className="orange">deeper</span> into UI/UX, experimenting with animations
            and APIs, or just shipping
            <span className="orange"> clean</span>,<span className="orange"> scalable</span> code.
          </motion.p>
          ...
          >
            ...
            <span className="orange"> self-improvement through discipline</span> — in tech, fitness,
            and life.
          </motion.p>
          ...
          >
            My goal is to
            <span className="orange"> create impactful projects</span> that blend aesthetics with
            performance. Let’s
